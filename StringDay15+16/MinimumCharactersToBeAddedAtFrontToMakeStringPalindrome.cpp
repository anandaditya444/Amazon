...
prefix which is also suffix. We can use this lps array for solving the problem.
	...
	For string = AACECAAAA
	             Concatenated String = AACECAAAA$AAAACECAA
	                                   ...
	                                   it shows us the largest suffix of the reversed string that matches the
	                                   prefix of the original string i.e these many characters already satisfy
	                                   the palindrome property. Finally minimum number of character needed to
	                                   make the string a palindrome is length of the input string minus last
	                                   entry of our lps array. Pease see below code for better understanding
